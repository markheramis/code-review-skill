...
12. Separate every conclusion into `Confirmed`, `Assumption`, `Unknown`, or `Validation`.
13. Record exact commands, tools, coverage tooling checked, output, research sources, and cleanup status. Do not claim tests or coverage checks passed unless run in this review.
